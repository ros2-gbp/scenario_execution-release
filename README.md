## scenario_execution (lyrical) - 1.7.0-1

The packages in the `scenario_execution` repository were released into the `lyrical` distro by running `/tmp/claude-1000015/-home-pafr0002-git-rrp/149dd97a-468d-4cc5-90ec-9c2b4dace688/scratchpad/se-ci/build/release/bloom-rehearsal-1.7.0/venv/bin/bloom-release --rosdistro lyrical --track lyrical scenario_execution` on `Mon, 21 Sep 2026 16:31:39 -0000`
...
## scenario_execution (jazzy) - 1.7.0-1

The packages in the `scenario_execution` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy scenario_execution` on `Mon, 21 Sep 2026 15:49:52 -0000`
...
## scenario_execution (jazzy) - 1.6.0-2

The packages in the `scenario_execution` repository were released into the `jazzy` distro by running `/tmp/se/bin/bloom-release --rosdistro jazzy --track jazzy scenario_execution` on `Sat, 19 Sep 2026 15:06:14 -0000`
...
## scenario_execution (jazzy) - 1.6.0-1

The packages in the `scenario_execution` repository were released into the `jazzy` distro by running `/tmp/se/bin/bloom-release --rosdistro jazzy --track jazzy scenario_execution` on `Sat, 19 Sep 2026 15:02:48 -0000`
