...
class TestLoadWorld(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.srv = self.node.create_service(LoadWorld, "/load_world", self.service_callback)
...
scenario test_load_world:
    timeout(10s)
    do serial:
        load_world('file:///path/to/world.sdf')
"""
